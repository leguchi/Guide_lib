      ...
      components: [
        {
          style: 4,
          label: `Back`,
          custom_id: `nextStep2SelectAccount`,
          disabled: false,
          type: 2
        },
        {
  ...
  embeds: [
    {
      ...
      description: `Now on your new project click and change the endpoint trigger that is originally set to HTTP(S) to be \`Discord\`, event details as \`command\`, and then command as \`ping\`.`,
      color: 0x00ff00,
      url: `https://autocode.com/guides/how-to-build-a-discord-bot/#new-autocode-project`,
      image: {
        url: `https://i.imgur.com/NzukQpT.png`,
        height: 256,
        width: 0
      },
    }
