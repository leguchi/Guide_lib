  ...
  components: [
    {
      ...
      components: [
        ...
        },
        {
          style: 3,
          label: `Next`,
          custom_id: `nextStep1ServerMembersIntent`,
          disabled: false,
          type: 2
        }
      ]
  ...
  embeds: [
    {
      ...
      description: `Now Click \`Add Bot\` on the bot tab of your new application, this will create a bot user which you can add to servers.`,
      color: 0x00ff00,
      url: `https://autocode.com/guides/how-to-build-a-discord-bot/#install-bot`,
      image: {
        url: `https://i.imgur.com/e2ZgLKs.png`,
        height: 256,
        width: 0
      },
    }
