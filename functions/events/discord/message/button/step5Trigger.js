      ...
      "components": [
        {
          "style": 4,
          "label": `Back`,
          "custom_id": `nextStep5CompletedReading`,
          "disabled": false,
          "type": 2
        },
        {
  ...
  "embeds": [
    {
      ...
      "description": "Make the trigger: Discord >> message.create.prefix (not message.create) >> and prefix can be `!warn`. On the left it says it is required. It also does mention it has to be a string, but you don't have to worry about it being in quotes just yet.",
      "color": 0x00ff00,
      "image": {
        "url": `https://i.imgur.com/cUnFE7l.png`,
        "height": 256,
        "width": 0
      },
