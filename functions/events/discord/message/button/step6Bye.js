  ...
  "embeds": [
    {
      ...
      "description": "You can do something similar for a \"goodbye\" version:\n\n```js\n// Only respond to messages containing \"cya\", \"gtg\", or \"bye\"\nif (context.params.event.content.match(/cya|gtg|bye/i)) {\n  await lib.discord.channels['@0.3.0'].messages.create({\n    channel_id: context.params.event.channel_id,\n    content: 'See you later, alligator 🐊',\n    message_reference: {\n      message_id: context.params.event.id\n    }\n  });\n}\n```\nYou can add more terms within the `match()` function's parameter that includes a regular expression. You can check more info on regular expression [here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions).",
      "color": 0x00ff00,
