  ...
  "embeds": [
    {
      ...
      "description": "Here's an example of the bot responding after I say \"hi\" or \"gtg\". Keep in mind how as you have it for now, it would pick up words that contain those terms, ex. \"think\". If you'd like for it to be only for the words such as \"hi\", you can include the assertion of `\\b` at the beginning and end of each word. For more info, click [here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions/Assertions).",
      "color": 0x00ff00,
      "image": {
        "url": `https://i.imgur.com/9CSpAgN.png`,
        "height": 256,
        "width": 0
      },
