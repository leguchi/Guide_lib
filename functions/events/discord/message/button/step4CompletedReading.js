  ...
  "components": [
    {
      ...
      "components": [
        ...
        },
        {
          "style": 3,
          "label": `Next`,
          "custom_id": `nextStep4CreateCommand`,
          "disabled": false,
          "type": 2
        }
      ]
  ...
  "embeds": [
    {
      ...
      "description": `[Here](https://autocode.com/tools/discord/command-builder/) is the command builder. The command builder is used for, as it says in the name, building the command. The first highlighted rectangle is where you'll select which bot you are creating the commands for. The second is for which guild. It is possible for the commands to be made global, however, for the first bot, we suggest you keep it being made for a specific guild only.`,
      "color": 0x00ff00,
      "image": {
        "url": `https://i.imgur.com/RCy9WIw.png`,
        "height": 256,
        "width": 0
      },
