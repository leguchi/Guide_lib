  ...
  "embeds": [
    {
      ...
      "description": "After you have the code copied onto the clipboard, you can head back to the file in your project and replace the example code that's already there. Remember to change the `channel_id` to the id of the channel you'd like the message to be sent in once the new member arrives.",
      "color": 0x00ff00,
      "image": {
        "url": `https://i.imgur.com/U4J39cd.png`,
        "height": 256,
        "width": 0
      },
