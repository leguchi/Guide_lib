      ...
      "components": [
        {
          "style": 4,
          "label": `Back`,
          "custom_id": `nextStep6CompletedReading`,
          "disabled": false,
          "type": 2
        },
        {
          "style": 3,
          "label": `Next`,
          "custom_id": `nextStep6RegularExpression`,
          "disabled": false,
          "type": 2
        }
      ]
  ...
  "embeds": [
    {
      ...
      "description": "Replace the code that's already there with this:\n```js\n// authenticates you with the API standard library\n// type `await lib.` to display API autocomplete\nconst lib = require('lib')({token: process.env.STDLIB_SECRET_TOKEN});\n\n// Only respond to messages containing \"hello\".\nif (context.params.event.content.toLowerCase().includes('hello')) {\n\n  await lib.discord.channels['@0.3.0'].messages.create({\n    channel_id: context.params.event.channel_id,\n    content: `Hello to you too 👋!`,\n    message_reference: {\n      message_id: context.params.event.id\n    }\n  });\n}\n```\n`context.params.event` is the data that would be brought into the endpoint. In the `if` statement, it's checking whether the message includes a \"hello\". For more info on strings, click [here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String). For more on if statements, click [here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/if...else).",
      "color": 0x00ff00,
