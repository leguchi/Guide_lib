...
await lib.discord.channels['@0.3.0'].messages.update({
  ...
  "embeds": [
    {
      "type": "rich",
      "title": `You are now an awesome Autocode developer!`,
      "description": `Great work, thank you for following along, and enjoy using Autocode for projects (outside of Discord, too!)`,
      "color": 0x00ff00,
